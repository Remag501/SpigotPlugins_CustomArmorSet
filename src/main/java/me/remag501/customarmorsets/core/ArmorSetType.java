...
public enum ArmorSetType {
    SNOWMAN("snowman", "Snow Man", Color.WHITE.asRGB(), 0,
    ...
    INFERNUS("infernus", "Infernus", 7, 1008, null,
            ...
            new int[]{0, 2, 2, 0}),
    ROYAL_KNIGHT("royal_knight", "Royal Knight", Color.GRAY.asRGB(), 0,
    ...
    LAST_SPARTAN("last_spartan", "Last Spartan", Color.RED.asRGB(),0,
    ...
    VIKING_CAPTAIN("viking_captain", "Viking Captain", Color.MAROON.asRGB(),0,
    ...
    BANDIT("bandit", "Bandit", 6,1007, null,
            BanditArmorSet::new,
    ...
    DEVOID("devoid", "Devoid", 5,1006, null,
            DevoidArmorSet::new,
    ...
    WORLD_GUARDIAN("world_guardian", "World Guardian", 4,1005, null,
            ...
            new int[]{2, 3, 2, 1}),
    VAMPIRE("vampire", "Vampire", Color.fromRGB(3,1,7).asRGB(),2017, null,
            VampireArmorSet::new,
    ...
    ARCHER("archer", "Archer", Color.fromRGB(4, 2, 7).asRGB(),2013, null,
            ArcherArmorSet::new,
            Arrays.asList("§6Ability: §eArrow slash and knockback", "§6Passive: §eSpeed, Half HP, 25% more bow damage"),
            new int[]{1, 3, 2, 1},
            new int[]{45, 160, 140, 120},
            new int[]{0, 0, 0, 0}),
    NECROMANCER("necromancer", "Necromancer", Color.fromRGB(2,0,7).asRGB(),1009, null,
    ...
    GOLEM_BUSTER("golem_buster", "Golem Buster", Color.fromRGB(4,1,7).asRGB(),2012, null,
    ...
    ArmorSetType(String id, String displayName, int leatherColor, int customModelData, String headUrl,
